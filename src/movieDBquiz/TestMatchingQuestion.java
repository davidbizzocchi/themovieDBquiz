...
public class TestMatchingQuestion {
	...
	/**
	 * Tests if a title is successfully added into the ArrayList of possible
	 * Answers.
	 */
	@Test
	...
	/**
	 * Tests that an error is thrown when the movie title is given an invalid
	 * null argument.
	 */
	...
	/**
	 * Tests that the array list of answers for the current question has exactly
	 * 4 answers.
	 */
	@Test
	...
	/**
	 * Test that an error is thrown when too large of a an index is set for the
	 * correct answer.
	 */
	@Test(expected = IllegalArgumentException.class)
